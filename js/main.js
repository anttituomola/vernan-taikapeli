...
window.VT = {
  ...
  kitchenTap: handleKitchenTap,
  herdTap: handleHerdTap,
  mine: function () { return mine; },
  mineTap: handleMineTap,
  rapids: function () { return rapids; },
  rapidsTap: handleRapidsTap,
  lighthouse: function () { return lh; },
  lighthouseTap: handleLighthouseTap,
  summit: function () { return { crystals: sumCrystals, rocks: sumRocks, winds: sumWinds, door: sumDoor }; },
  letterfield: function () { return lf; },
  letterfieldTap: handleLetterfieldTap,
  ...
  magician: function () { return mag; },
  voyage: function () { return { voy: voy, stars: voyStars, ice: voyIce, dock: voyDock }; },
  aurora: function () { return { lights: aurLights, gate: aurGate, wind: aurWind }; },
  reindeer: function () { return { deer: reinDeer, rocks: reinRocks, pen: reinPen }; },
